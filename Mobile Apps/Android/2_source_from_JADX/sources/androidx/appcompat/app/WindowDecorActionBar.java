...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0008R.C0010id.decor_content_parent);
        ...
        ActionBarContainer actionBarContainer = (ActionBarContainer) decor.findViewById(C0008R.C0010id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0008R.styleable.ActionBar, C0008R.attr.actionBarStyle, 0);
