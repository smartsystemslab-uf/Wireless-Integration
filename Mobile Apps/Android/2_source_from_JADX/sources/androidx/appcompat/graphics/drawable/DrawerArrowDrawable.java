...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0008R.styleable.DrawerArrowToggle, C0008R.attr.drawerArrowStyle, C0008R.style.Base_Widget_AppCompat_DrawerArrowToggle);
