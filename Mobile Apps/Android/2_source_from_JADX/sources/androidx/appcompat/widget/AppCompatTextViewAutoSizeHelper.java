...
class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0008R.styleable.AppCompatTextView, attrs, a, defStyleAttr, 0);
        ...
        if (a.hasValue(C0008R.styleable.AppCompatTextView_autoSizePresetSizes) && (autoSizeStepSizeArrayResId = a.getResourceId(C0008R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
