...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0008R.styleable.SwitchCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        Drawable drawable = a.getDrawable(C0008R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = a.getDrawable(C0008R.styleable.SwitchCompat_track);
        ...
        PorterDuff.Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0008R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        PorterDuff.Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0008R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
