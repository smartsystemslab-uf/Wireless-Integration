...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0008R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0008R.C0010id.image);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (itemViewType == 0) {
                ...
                View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0008R.layout.abc_activity_chooser_view_list_item, parent, false);
                convertView2.setId(1);
                ((TextView) convertView2.findViewById(C0008R.C0010id.title)).setText(ActivityChooserView.this.getContext().getString(C0008R.string.abc_activity_chooser_view_see_all));
                return convertView2;
            }
        }
