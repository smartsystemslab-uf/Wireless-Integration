...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0008R.styleable.Toolbar, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        ...
        titleMargin = a.hasValue(C0008R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C0008R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0008R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            AppCompatImageButton appCompatImageButton = new AppCompatImageButton(getContext(), (AttributeSet) null, C0008R.attr.toolbarNavigationButtonStyle);
