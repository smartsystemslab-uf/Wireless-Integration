...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0008R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        ...
        if (ap != -1) {
            ...
            if (!hasPwdTm && a2.hasValue(C0008R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0008R.styleable.TextAppearance_textAllCaps, false);
            }
            ...
            if (a2.hasValue(C0008R.styleable.TextAppearance_textLocale)) {
                localeListString3 = a2.getString(C0008R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0008R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation2 = a2.getString(C0008R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        ...
        if (hasPwdTm || !a3.hasValue(C0008R.styleable.TextAppearance_textAllCaps)) {
            ...
            allCaps = a3.getBoolean(C0008R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        }
        if (Build.VERSION.SDK_INT < 23) {
        ...
        if (Build.VERSION.SDK_INT < 26 || !a3.hasValue(C0008R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        if (a4.hasValue(C0008R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a4.getInt(C0008R.styleable.AppCompatTextView_drawableTintMode, -1), (PorterDuff.Mode) null));
        }
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        boolean z = false;
        if (Build.VERSION.SDK_INT >= 28) {
            int i2 = tintTypedArray.getInt(C0008R.styleable.TextAppearance_android_textFontWeight, -1);
            this.mFontWeight = i2;
            if (i2 != -1) {
        ...
        if (tintTypedArray.hasValue(C0008R.styleable.TextAppearance_android_fontFamily) || tintTypedArray.hasValue(C0008R.styleable.TextAppearance_fontFamily)) {
            ...
            if (tintTypedArray.hasValue(C0008R.styleable.TextAppearance_fontFamily)) {
                i = C0008R.styleable.TextAppearance_fontFamily;
            } else {
                i = C0008R.styleable.TextAppearance_android_fontFamily;
            }
            int fontFamilyId = i;
        ...
        } else if (tintTypedArray.hasValue(C0008R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = tintTypedArray.getInt(C0008R.styleable.TextAppearance_android_typeface, 1);
            if (typefaceIndex == 1) {
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0008R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0008R.styleable.TextAppearance_android_textColor)) != null) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0008R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0008R.styleable.TextAppearance_fontVariationSettings)) != null) {
            this.mView.setFontVariationSettings(fontVariation);
        }
        a.recycle();
        Typeface typeface = this.mFontTypeface;
