...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f29x;
        float position3 = position2;
        float position4 = motionPaths.f30y;
        float endCenterX = motionPaths2.f29x + (f / 2.0f);
        float endCenterY = motionPaths2.f30y + (f3 / 2.0f);
        float pathVectorX = endCenterX - (f5 + (f2 / 2.0f));
        float pathVectorY = endCenterY - (position4 + (f4 / 2.0f));
        this.f29x = (float) ((int) ((f5 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f30y = (float) ((int) ((position4 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        ...
        this.mMode = 2;
        this.f29x = (float) ((int) (((motionPaths.f29x + (pathVectorX * dxdx)) + (pathVectorY * dxdy)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f30y = (float) ((int) (((motionPaths.f30y + (pathVectorX * dydx)) + (pathVectorY * dydy)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f29x;
        float f6 = position2;
        float position3 = motionPaths.f30y;
        float endCenterX = motionPaths2.f29x + (f / 2.0f);
        float endCenterY = motionPaths2.f30y + (f3 / 2.0f);
        this.f29x = (float) ((int) ((f5 + ((endCenterX - (f5 + (f2 / 2.0f))) * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f30y = (float) ((int) ((position3 + ((endCenterY - (position3 + (f4 / 2.0f))) * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        this.height = (float) ((int) (f4 + (scaleY * scaleHeight)));
        this.mMode = 3;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f29x = (float) ((int) (keyPosition.mPercentX * ((float) ((int) (((float) parentWidth) - this.width)))));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f30y = (float) ((int) (keyPosition.mPercentY * ((float) ((int) (((float) parentHeight) - this.height)))));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    public void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f = motionPaths.f29x;
        float f2 = motionPaths.width;
        float f3 = motionPaths.f30y;
        float f4 = position2;
        float position3 = motionPaths.height;
        float endCenterX = motionPaths2.f29x + (motionPaths2.width / 2.0f);
        float endCenterY = motionPaths2.f30y + (motionPaths2.height / 2.0f);
        float pathVectorX = endCenterX - ((f2 / 2.0f) + f);
        float pathVectorY = endCenterY - (f3 + (position3 / 2.0f));
        this.f29x = (float) ((int) ((f + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f30y = (float) ((int) ((f3 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        ...
        float f6 = (float) ((int) ((motionPaths3.f29x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f29x = f6;
        float f7 = pathVectorX;
        float f8 = (float) ((int) ((motionPaths3.f30y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.f30y = f8;
        this.f29x = f6 + ((-pathVectorY) * perpendicular);
        this.f30y = f8 + (pathVectorX * perpendicular);
