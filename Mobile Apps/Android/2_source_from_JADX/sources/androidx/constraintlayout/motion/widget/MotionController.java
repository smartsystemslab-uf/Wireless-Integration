...
public class MotionController {
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f29x + ((this.mEndMotionPath.f29x - this.mStartMotionPath.f29x) * position);
            float float_t = this.mStartMotionPath.f30y + ((this.mEndMotionPath.f30y - this.mStartMotionPath.f30y) * position);
