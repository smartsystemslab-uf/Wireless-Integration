...
public class Easing {
    ...
    static class CubicEasing extends Easing {
        ...
        CubicEasing(String configString) {
            ...
            this.f16y2 = Double.parseDouble(configString.substring(off3 + 1, configString.indexOf(41, off3 + 1)).trim());
        }
        ...
        private double getX(double t) {
            double t1 = 1.0d - t;
            return (this.f13x1 * t1 * 3.0d * t1 * t) + (this.f14x2 * 3.0d * t1 * t * t) + (t * t * t);
        }

        private double getY(double t) {
            double t1 = 1.0d - t;
            return (this.f15y1 * t1 * 3.0d * t1 * t) + (this.f16y2 * 3.0d * t1 * t * t) + (t * t * t);
        }
