...
public abstract class FragmentTransaction {
    ...
    static final class C0224Op {
        ...
        C0224Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0224Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0224Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0224Op(10, fragment, state));
        return this;
    }
